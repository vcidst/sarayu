...
external_stylesheets = ['https://codepen.io/ziscore/pen/xxVPvWJ.css', 'https://codepen.io/chriddyp/pen/bWLwgP.css']
...
app.layout = html.Div([
    ...
    Make sure it has a RecipeFlow column. \
    Tip: Filter only a single recipe to avoid messy diagrams", className="leadin"),
    dcc.Upload(
        id='upload-data',
        children=html.Div([
            'Drag and Drop or ',
